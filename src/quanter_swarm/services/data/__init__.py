"""Data providers and feed integrations."""
...
from quanter_swarm.services.data.registry import (
    available_providers,
    create_provider,
    register_provider,
)
...
try:
    ...
    from quanter_swarm.services.data.live_providers import CompanyIRProvider as _CompanyIRProvider
    from quanter_swarm.services.data.live_providers import (
    ...
    from quanter_swarm.services.data.live_providers import FredMacroProvider as _FredMacroProvider
    from quanter_swarm.services.data.live_providers import (
        PolygonMarketDataProvider as _PolygonMarketDataProvider,
    )
    from quanter_swarm.services.data.live_providers import SecFilingsProvider as _SecFilingsProvider
    from quanter_swarm.services.data.live_providers import (
...
try:
    from quanter_swarm.services.data.file_provider import FileDataProvider as _FileDataProvider
