...
from quanter_swarm.services.data.news_feed import fetch_news
from quanter_swarm.services.data.price_feed import get_latest_price as fetch_latest_price
...
class BaseDataProvider(ABC):
    ...
    def get_fundamentals(self, symbol: str) -> dict[str, Any]:
        from quanter_swarm.services.data.fundamentals_feed import fetch_fundamentals
    ...
    def get_macro(self, symbol: str) -> dict[str, Any]:
        from quanter_swarm.services.data.macro_feed import fetch_macro_snapshot
...
def get_default_data_provider() -> BaseDataProvider:
    ...
    if provider_name:
        from quanter_swarm.services.data.registry import create_provider
